    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute top-1/2 -translate-y-1/2 -right-px z-30 flex flex-col items-center gap-1 bg-white border border-r-0 border-gray-200 shadow-md rounded-l-xl px-1.5 py-3 text-gray-500 hover:text-[#7C3AED] transition-colors"
          title={
            drawerOpen
              ? "Recolher painel do paciente"
              : "Expandir painel do paciente"
          }
        >
